...
class RestsControllerTest < ActionController::TestCase
  ...
  test "should create rest" do
    assert_difference('Rest.count') do
      post :create, rest: { address: @rest.address, description: @rest.description, name: @rest.name, owner: @rest.owner, phone: @rest.phone }
    end
  ...
  test "should update rest" do
    patch :update, id: @rest, rest: { address: @rest.address, description: @rest.description, name: @rest.name, owner: @rest.owner, phone: @rest.phone }
    assert_redirected_to rest_path(assigns(:rest))
  end
